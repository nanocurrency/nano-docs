...
Also called online stake, it is a trended value. The node samples online representative weights every 5 minutes. The online voting weight value is the median of those samples.
